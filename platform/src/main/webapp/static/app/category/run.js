...
require({
	...
	packages: [
		...
		{ name: 'dojo', location:  '../dojo', map: {} },
		{ name: 'dijit', location:  '../dijit', map: {} },
		{ name: 'dojox', location:  '../dojox', map: {} },
		{ name: 'gridx', location:  '../gridx', map: {} },
		{ name: 'category', location:  '../app/category', map: {} },
		// For reference, this is what a more verbose package declaration looks like.
		{ name: 'product', location:  '../app/product', map: {} }
	]
